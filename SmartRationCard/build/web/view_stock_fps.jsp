	...
	<div class="reg" style="background-color:gray; height:auto;">
	    <br>
		 <form action="CustemerDistribute" class="register" method="post">
            <h1 style="font-size:20pt;">VIEW FPS STOCK</h1>
            <fieldset class="row1">
                <legend>
                </legend>
              <div class="col-md-12">
                  ...
                  <%
										       ...
										       Connection con=Database.getConnection(); 
												//PreparedStatement ps=con.prepareStatement("select * from taluka_distribute ");
												Statement stmt=con.createStatement();
											ResultSet rs=stmt.executeQuery("select * from fps_disribute");
										 %>
                        ...
                        <table class="table table-stripped table-responsive" style="color:black;align:center;overflow-x:scroll;">
							...
							while(rs.next()){
								...
								out.println("<td>");out.print(rs.getString(1));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(2));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(3));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(4));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(5));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(6));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(7));	out.println("</td>");
								out.println("<td>");out.print(rs.getString(8));	out.println("</td>");
