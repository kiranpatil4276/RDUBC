...
<!--header-top-->
	...
	<!--script-for-menu-->
	<div class="reg" style="background-color:gray; height:404px;">
	    <br>
		 <form action="" class="register">
            <h1 style="font-size:20pt;">Family List</h1>
            <fieldset class="row1">
                <legend>
                </legend>
                  <% 
               ...
               try{ Class.forName("com.mysql.jdbc.Driver");  
				 ...
				 ResultSet rs=stmt.executeQuery("select * from mem_reg where id='"+id1+"'");
				 int count=1;
				 while(rs.next()){
                                     	%> 
              <center><u><h4>Member :<%=count++%> </h4></u></center>
              <div class="col-md-12">
                  <div class="row">
		                    ...
		                    <div class="form-group col-md-4">
		                        <label>Name : </label> <%=rs.getString(2) %>
			                 </div>
		                    <div class="form-group col-md-4 ">
		                       <label>Relation : </label> <%=rs.getString(6) %>
			                </div>
		            		<div class="form-group col-md-4">
                               <label>Age: </label> <%=rs.getString(3) %>
			             	</div>
			             	</div>
			             	<div class="row">
		                    <div class="form-group col-md-4 ">
		                        <label>BirthDate : </label> <%=rs.getString(4) %>
			                 </div>
		                    
		                     <div class="form-group col-md-4 ">
		                        <label>Gender : </label> <%=rs.getString(5) %>
			                 </div>
		               </div> 
