	...
	<div class="reg" style="background-color:gray; height:auto;">
	    <br>
		 <form action="Changepass" class="register" method="post">
            <h1 style="font-size:20pt;">Change Password</h1>
			                  ...
			                  <div class="col-md-8 col-md-offset-3">
			                        <div class="row">
					                    <div class="col-md-4">
						                    ...
						                    <label><input type="password" name="c_pass"></label>
						                    </div>
					                    </div>
					                 </div>
					                 <div class="row">
					                    <div class="col-md-4">
						                    ...
						                    <label><input type="password" name="change_pass"></label>
						                    </div>
					                    </div>
					                 </div>
					                 <div class="row">
					                    <div class="col-md-4">
						                    ...
						                    <label><input type="password" name="comfirm_pass"></label>
						                    </div>
					                    </div>
					                 </div>
					                <button class="btn btn-primary" style="margin-left:150px;">Change Password</button>
