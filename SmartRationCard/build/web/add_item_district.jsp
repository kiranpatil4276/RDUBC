		...
		<div class="container">
			<div class="head-main">
				...
				<div class="col-md-6 head-left wow fadeInRight animated" data-wow-delay=".5s">
                    <a href="Login.html"><i class="fa fa-user fa-lg"></i>Sign In</a> &nbsp
					<a href="Student_register.html"><i class="fa fa-user fa-lg"></i>Sign Up</a>					
					<!--<ul>
	...
	<div class="navigation animated " data-wow-duration="1200ms" data-wow-delay="500ms" style="background-color:skyblue;">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
				...
				<li><a href="district_taluka.jsp">TALUKA</a></li>
				<li><a href="district_fps.jsp">FPS</a></li>
			</ul>
	</div>
	<!--navigation-end-->
	<!--script-for-menu-->
	...
	<div class="reg" style="background-color:gray; height:665px;">
	    <br>
		 <form action="" class="register">
            <h1 style="font-size:20pt;">ADD ITEMS FOR TALUKA</h1>
            <fieldset class="row1">
                <legend>
                </legend>
              <div class="col-md-12">
                  ...
                  <div class="col-md-11 col-md-offset-1">
		                    ...
		                    <div class="col-md-4 col-md-offset-1">
			                    ...
			                    <input type="text" class="form-control" name="added_date" placeholder="Total available stock"/>
			                    </div>
		                    </div>
		             </div>
                  <div class="col-md-11 col-md-offset-1">
		                    <div class="col-md-4">
                               <div class="form-group">
			                    ...
			                    <input type="text"  class="form-control" name="item_rate" placeholder=" Enter Item rate  "/>
			                    </div>
		                    </div>
		                    <div class="col-md-4 col-md-offset-1">
		                        <div class="form-group">
		            ...
		            <div class="col-md-11 col-md-offset-1">
		                    ...
		                    <div class="col-md-4 col-md-offset-1">
                               <div class="form-group">
			                    ...
			                    <input type="text"  class="form-control" name="item_unit" placeholder=" Enter Item Unit  "/>
			                    </div>
		                    </div>
