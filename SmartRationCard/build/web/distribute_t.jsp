    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#officer').change(function () {
                var id = $(this).val();
                var url = 'selectvillage.jsp?id=' + id;
                $.ajax({
                    url: url,
                    dataType: 'json',
...
<body>
    ...
    <div class="navigation animated " data-wow-duration="1200ms"
        ...
        <ul class="navig cl-effect-16">
            <li><a href="taluka_home.jsp">Home</a></li>

            <li><a href="view_fps_taluka.jsp">FPS</a></li>
        </ul>
    </div>
    <!--navigation-end-->
    <!--script-for-menu-->
    ...
    <div class="reg" style="background-color: gray; height: 665px;">
        <br>
        <form action="add_taluka" class="register" method="post">
            <!-- Form>>>>>>>>>>>>>>>>>>>>>>>>>> -->
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-11 col-md-offset-1">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Select Fps Officer:</label> <select
                                        class="form-control" id="officer" name="officer">
                                        <option value="">Select</option>
                                        <%
                                            String taluka = session.getAttribute("taluka").toString();
                                            Connection con = Database.getConnection();
                                            //PreparedStatement ps=con.prepareStatement("select * from users ");
                                            Statement stmt = con.createStatement();
                                            ResultSet rs = stmt.executeQuery("select * from users where category='fps' and taluka='" + taluka + "'");
                                            while (rs.next()) {
                                        %>
                        ...
                        <div class="col-md-11 col-md-offset-1" id="Item">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Select Item:</label> <select class="form-control item"
                                                                        name="item_name">

                                        <%
                                            Connection conn = Database.getConnection();
                                            PreparedStatement ps1 = conn.prepareStatement("select item_name from item_detail1");
                        ...
                        <div class="col-md-11 col-md-offset-1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Added Date </label> <input type="text" id="datepicker"
                                                                      class="form-control" name="date"
                                                                      value="<%=dNow.format(d)%>" readonly  />
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <input type="submit" class="btn btn-success" style="margin-left: 380px;" value="submit"
                       name="submit">
                </div>
            </fieldset>
    ...
    <script>
        $(document).ready(function () {
            $("#add").click(function () {
                var member = '<div><div class="col-md-11 col-md-offset-1" id="Item">' +
                        ' <div class="col-md-4">' +
                        '<div class="form-group">' +
