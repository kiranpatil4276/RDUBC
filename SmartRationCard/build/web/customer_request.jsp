    ...
    <body>
        ...
        <div class="navigation animated " data-wow-duration="1200ms" data-wow-delay="500ms" style="background-color:skyblue;">
            ...
            <!-- <ul class="navig cl-effect-16">
                    ...
                    <li><a href="view_item_t.jsp">FPS</a></li>
            </ul> -->
        </div>
        <!--navigation-end-->
        <!--script-for-menu-->
        ...
        <div class="reg" style="background-color:gray; height:665px;">
            ...
            <form action="" class="register" method="post">
                <h1 style="font-size:20pt;">Customer Requests List</h1>
                <fieldset class="row1">
                    <legend>
                    </legend>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-11 col-md-offset-2">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover" style="margin-left:-10%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ...
                                                ResultSet rs = stmt.executeQuery("select * from register where taluka='"+taluka+"'");
                                        ...
                                        %>
                                    <td><center><a href="customer_verify1.jsp?id=<%=rs.getInt(1)%>&village=<%=rs.getString("village")%>"> Edit <i class="fa fa-fw fa-pencil"></i> </a>
                                            <%
                                                    }
                                                } catch (Exception e) {
                                            ...
                                            <!-- 
                                              <a href="#" onclick="delete_record('#'" > Delete <i class="fa fa-fw fa-close"></i> </a> 
