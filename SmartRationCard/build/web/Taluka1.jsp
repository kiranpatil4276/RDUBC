	...
	<div class="navigation animated " data-wow-duration="1200ms" data-wow-delay="500ms" style="background-color:skyblue;">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
				...
				<li><a href="view_item_taluka.jsp">Taluka</a></li>
				<li><a href="view_item_fps.jsp">FPS</a></li>
			</ul>
	</div>
	<!--navigation-end-->
	<!--script-for-menu-->
	...
	<div class="reg" style="background-color:gray; height:665px;">
	    <br>
		 <form action="" class="register">
            <h1 style="font-size:20pt;">VIEW TALUKA STOCK</h1>
            <fieldset class="row1">
                <legend>
                </legend>
              <div class="col-md-12">
                  ...
                  <div class="col-md-10 col-md-offset-1">
                									<%
                									String s=request.getParameter("officer");
                									Connection con=Database.getConnection(); 
													Statement stmt=con.createStatement();
													ResultSet rs=stmt.executeQuery("select * from  where officer='"+s+"' ");
