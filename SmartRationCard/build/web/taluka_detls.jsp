...
<!--header-top-->
	...
	<div class="navigation animated " data-wow-duration="1200ms" data-wow-delay="500ms" style="background-color:skyblue;">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
				...
				<li><a href="taluka_detls.jsp">TALUKA</a></li>
	...
	<div class="reg" style="background-color:gray; height:665px;">
	    <br>
		 <form action="Fpsstock" class="register" method="post">
            <h1 style="font-size:20pt;">Application Requests List</h1>
            <fieldset class="row1">
                <legend>
                </legend>
              <div class="col-md-12">
		          ...
		          <table class="table table-responsive table-striped table-bordered table-hover" style="margin-left:-10%">
                            ...
                            int id=1;
												...
												PreparedStatement ps=conn.prepareStatement("select * from users WHERE category='taluka'");
                                ...
                                <tr>
                                   ...
                                   <td><center><a href="#" > Edit <i class="fa fa-fw fa-pencil"></i> </a>
