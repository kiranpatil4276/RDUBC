...
{%>
    ...
    <body>
        ...
        <div class="reg" style="background-color: gray; height: 665px;">
            <br>
            <form action="FoodRequest" class="register" method="post" name="form1" id="form1">
                <h1 style="font-size: 20pt;">REQUEST ITEMS </h1>
                <fieldset class="row1">
                    <%-- 	<%
                    ...
                    <div class="col-md-11 col-md-offset-1" id="card">
                        ...
                        %>
                                ...
                                <input type="text" class="form-control item"  list="rno" class="form-control item" name="rationcard_no"  value="<%=rs.getString("rfid").toString().trim()%>" placeholder="Ration card number" id="rationcard_no">
                            </div>
                                 <%   }
                                        } catch (Exception e) {
...
%>
    ...
    <script>
        ...
        <%
            ...
            PreparedStatement p = conn.prepareStatement("select * from add_item");
