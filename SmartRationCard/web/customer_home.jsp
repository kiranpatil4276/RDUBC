...
<% } else
{%>
<title>Smart Ration Card System | Home</title>
		...
		<div class="container">
			<div class="head-main">
				...
				<div class="col-md-6 head- animated wow fadeInDown animated animated" data-wow-duration="1200ms" data-wow-delay="500ms" >
					<h1><img src="images/india.png" height="08%" width="11%" style="margin-top:-20px;"/>&nbsp <a href="index.jsp">Smart Ration Card System</a></h1>
				</div>
...
<div class="welcome">
	<div class="container">
         <center>
         <a href="user_profile.jsp"><button class="btn btn-info">User Profile</button></a>
         <a href="user_family.jsp"><button class="btn btn-info">User Family</button></a>
         <a href="user_stock.jsp"><button class="btn btn-info">View My Stock</button></a>
          <a href="requestfood.jsp"><button class="btn btn-info">Request Food</button></a>
