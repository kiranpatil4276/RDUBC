...
<html>
    ...
    <body>
        ...
        <!--script-for-menu-->
        <div class="reg" style="background-color:gray; height:376px;">
            <br>
            <form action="User_stock1" class="register">
                <h1 style="font-size:20pt;">VIEW STOCK</h1>
                <fieldset class="row1">
                    <legend>
                    </legend>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <%
                                    ...
                                    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/smartrationcard", "root", "root");

                                    PreparedStatement ps = conn.prepareStatement("select * from item_detail3 where customer_name='" + uname + "'");
