                                        ...
                                        <table id="myTable" class="table table-striped table-bordered tabledata" style="overflow-x:auto;">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    PreparedStatement ps = conn.prepareStatement("select * from requestfood INNER JOIN register ON requestfood.rationcard=register.rationcard  where register.village='" + session.getAttribute("village") + "'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=rs.getString(4)%></td>
                                                      ...
                                                      <td><a href="accept.jsp?id=<%=rs.getString(1)%>">Accept </a></td>
                                                       <td><a href="reject.jsp?id=<%=rs.getString(1)%>">Reject</a> </td>
                                                    <% i++; %>
                                                </tr>
                                                <%}%>
                                            </tbody>
