                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <%
                                    ...
                                    String taluka = httpSession.getAttribute("taluka").toString();
                                    int i = 1;
                                    String name = null;
                                    String name1 = null;
                                    ...
                                    ResultSet rs = stmt.executeQuery("select * from item_detail2");
                                %>
                                ...
                                <table class="table table-stripped table-responsive" style="color:black;align:center;overflow-x:scroll;">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            while (rs.next()) {
                                                String distribution_id = rs.getString("distribution_id");
                                                Statement stmt1 = con.createStatement();
                                                String taluka1 = "";
                                                ResultSet rs1 = stmt1.executeQuery("select * from users where userid='" + distribution_id + "' and taluka='" + taluka + "'");
                                                while (rs1.next()) {
                                                    name = rs1.getString(3);
                                                    name1 = rs1.getString(12);
                                                    taluka1 = rs1.getString(9);
                                                }
                                                if(taluka.equals(taluka1)){
                                                out.println("<tr>");
                                                out.println("<td>");
                                                out.print(i);
                                                out.println("</td>");
                                                //out.println("<td>");out.print(i);	out.println("</td>");
                                                out.println("<td>");
                                                out.print(name);
                                                out.println("</td>");
                                                out.println("<td>");
