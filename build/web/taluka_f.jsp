              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-11 col-md-offset-1">
		                    <div class="col-md-4">
		                        <div class="form-group">
									     <label>Select FPS Officer:</label>
											 <select class="form-control" id="officer" name="officer">
										 
										 <%
										 Connection con=Database.getConnection();
										 // PreparedStatement ps=con.prepareStatement("Select * from users where category='fps'");
										Statement stmt=con.createStatement();
										 ResultSet rs=stmt.executeQuery("select * from users where category='fps'");
                  ...
                  <div class="col-md-11 col-md-offset-1">
		            ...
		            <div class="col-md-11">
		                    ...
		                    <div class="col-md-4 col-md-offset-1" style="margin-left:96px;">
                               <div class="form-group">
		            ...
		            <div class="col-md-11">
                            ...
                            <input type="submit"  style="margin-left:380px;" name="submit">
