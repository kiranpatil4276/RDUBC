...
<!--header-top-->
	...
	<div class="reg" style="background-color:gray; height:665px;">
	    <br>
		 <form action="Fps_detles1" class="register" method="post">
            <h1 style="font-size:20pt;">FPS </h1>
            <fieldset class="row1">
                <legend>
                </legend>
              <div class="col-md-12">
                             ...
                             <thead>
                                <tr>
                                    ...
                                    <th><center></center></th>
                                     ...
                                     <td><center><a href="customer_verify.jsp"> Edit <i class="fa fa-fw fa-pencil"></i> </a>
