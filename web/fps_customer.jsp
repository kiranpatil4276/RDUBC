    ...
    <body>
        ...
        <div class="reg" style="background-color:gray; height:auto;">
            ...
            <form action="Fpsstock" class="register">
                <h1 style="font-size:20pt;">VIEW CUSTOMER DETAILS</h1>
                <fieldset class="row1">
                    <legend>
                    </legend>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <table class="table table-stripped table-responsive" border=1 style="color:black;align:center;overflow-x:scroll;">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            //String officer_name=session.getAttribute("uname").toString();
                                            try {
                                                ...
                                                ResultSet rs = stmt.executeQuery("select * from item_detail3");
                                                while (rs.next()) {
                                                    String name = rs.getString(7);
                                                    String sql = "Select * from register where name='" + name + "' and village='" + village + "'";
