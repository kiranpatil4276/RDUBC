...
<!--header-top-->
	...
	<div class="reg" style="background-color:gray; height:665px;">
	    <br>
		 <form action="Taluka1.jsp" class="register" method="post"><!-- Form>>>>>>>>>>>>>>>>>>>>>>>>>> -->
            ...
            <fieldset class="row1">
              ...
              <div class="col-md-12">
		                    ...
		                    <div class="col-md-4">
		                        <div class="form-group">
										 ...
										 <%
											...
											ResultSet rs=stmt.executeQuery("select * from users where category='taluka'");
										 while(rs.next())
										 {	 
										%>
                ...
                <input type="submit"  style="margin-left:380px;" value="submit" name="submit">
